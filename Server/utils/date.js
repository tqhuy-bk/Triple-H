...
function getLunarDate() {
    var _date = new Date();
    var dd = _date.getDate(), mm = _date.getMonth(), yyyy = _date.getFullYear();
    var ly, jd;
    ly = getYearInfo(yyyy);
    jd = jdn(dd, mm, yyyy);
    if (jd < ly[0].jd) {
...
function lunarToDateInt() {
    var x = getLunarDate();
    return x.day + x.month * 30;
}

function solarToDateInt() {
    var date = new Date();
    return date.getDate() + date.getMonth() * 30;
}

module.exports = { lunarToDateInt, solarToDateInt };